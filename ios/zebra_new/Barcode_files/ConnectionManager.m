...
- (void)dealloc
{
    ...
    [[zt_ScannerAppEngine BsharedAppEngine] removeDevConnectiosDelegate:self];
...
- (void) initializeConnectionManager
{
    ...
    [[zt_ScannerAppEngine BsharedAppEngine] addDevConnectionsDelegate:self];
}
...
- (void)connectDeviceUsingScannerId:(int)scannerId
{
    ...
    [[zt_ScannerAppEngine BsharedAppEngine] connect:scannerId];
}

// disconnect from both the scanner and rfid sdk using the scanner id
- (void) disconnect
{
    [[zt_ScannerAppEngine BsharedAppEngine] disconnect:[self.connectedScanner getScannerID]];
}
...
-(BOOL)scannerHasConnected:(int)scannerID
{
    ...
    else
    {
        ...
        self.connectedScanner = [[zt_ScannerAppEngine BsharedAppEngine] getScannerByID:scannerID];
    }
...
{
    self.connectedScanner = [[zt_ScannerAppEngine BsharedAppEngine] getScannerByID:scannerIdToConnect];
